    ...
    <div className="space-y-6">
      <section className="card p-5">
        ...
        <p className="mt-2 text-sm text-zinc-600">
          Roles: <b>super_admin</b> can manage everything, <b>admin</b> manages products/inventory, <b>employee</b>{" "}
          manages sales with view-only inventory access.
        </p>
      </section>
                ...
                {users.length === 0 ? (
                  ...
                  users.map((user) => (
                    <tr key={String(user._id)} className="border-b border-zinc-200 text-sm">
                      ...
                      <td className="py-2">৳ {Number(user.revenue || 0).toFixed(2)}</td>
                    </tr>
                  ))
                )}
              </tbody>
